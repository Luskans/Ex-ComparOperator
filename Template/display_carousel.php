...
<?php } else { ?>
    ...
    $destinationsData2 = $manager->getDestinationsByOperatorId($operatorData['id']);
    $destinationsCollection = [];
    foreach ($destinationsData2 as $destinationData2) {
        $destinationsCollection[] = new Destination($destinationData2);
    }
