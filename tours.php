...
<main>
    <div class="container operatorCards d-flex flex-wrap justify-content-center gap-3">

<?php
///// ON MET EN SESSION LES PARAMETRES DE LA PAGE POUR REVENIR DESSUS APRES AJOUT DE COMMENTAIRE OU SCORE
...
////// RECUPERE LES OPERATOR SELON LA DESTINATION
$operatorsData = [];
        ...
        <div class="operatorCard mb-5">
            <div class="operatorCard__title d-flex justify-content-between align-items-center pt-2 px-3">
                ...
                <?php if ($totalScore === 0) { ?>
                    <p class="score">0 ★</p>
                <?php } else { ?>
                    <p class="score"><?= $totalScore / $scoreCount ?> ★</p>
                <?php } ?>
            </div>
